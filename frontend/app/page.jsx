  ...
  return (
    <>
      <div className="h-screen bg-cream dark:bg-dark-bg">
        <Navbar />
        <div className="p-6">
          <div className="text-center mb-3 md:mb-6 md:flex md:justify-center gap-8 font-semibold md:text-2xl dark:text-light-gray">
            <h2 className="">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
            <Link href="/student" className="student">
              <div className="bg-white dark:bg-gray-300 p-6 rounded-md shadow-md text-center hover:bg-lime-400 dark:hover:bg-green-500 dark:border-[#2F3640] duration-300">
                <h2 className="text-xl font-semibold">Student Login</h2>
              </div>
            </Link>
            <Link href="/teacher" className="teacher">
              <div className="bg-white dark:bg-gray-300 p-6 rounded-md shadow-md text-center hover:bg-red-400 dark:hover:bg-red-500 dark:border-[#2F3640] duration-300">
                <h2 className="text-xl font-semibold">Teacher Login</h2>
              </div>
            </Link>
            <Link href="/administrator" className="admin">
              <div className="bg-white dark:bg-gray-300 p-6 rounded-md shadow-md text-center hover:bg-blue-400 dark:hover:bg-blue-500 dark:border-[#2F3640] duration-300">
