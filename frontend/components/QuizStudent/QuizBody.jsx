    ...
    <QuizLayout>
      ...
      <div className="mb-6">
        ...
        {upcomingQuiz.map((quiz) => (
          <div className="md:p-4 px-2 py-1 grid grid-rows-2 md:grid-rows-1 md:grid-cols-4 items-center gap-1 md:gap-2 border-b-2 border-b-violet-500 bg-slate-100 pb-1">
            <p className="">
              <Link
                href={`/student/quiz/#`}
                className="text-blue-600 underline underline-offset-2"
            ...
            <p
              className={`text-white ${
                quiz.status === "Attempted"
                  ? "bg-green-500 w-24 pl-3.5 md:w-28 md:pl-5"
                  : "bg-red-500 w-24 pl-2 md:w-28 md:pl-3.5"
              } rounded-full text-[14px] py-0.5`}
            >
              {quiz.status}
            </p>
            <p className="whitespace-pre hidden md:block"> {quiz.marks}</p>
