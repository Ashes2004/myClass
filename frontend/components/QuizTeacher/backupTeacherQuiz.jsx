      ...
      >
        <div className="text-xl lg:text-2xl font-semibold md:flex justify-between p-2 md:p-6 border-b-2 border-violet-400 text-gray-700">
          ...
          <div className="text-[14px] font-medium flex items-center gap-1 mt-2 md:mt-0">
            ...
            <input
              type="text"
              onChange={(e) => setTotalNoOfQuestions(Number(e.target.value))}
              className="w-10 h-8 text-center font-medium text-sm rounded-md border border-violet-500 "
            />
          </div>
        </div>
        ...
        <div className="px-4 md:px-10">
          ...
          <div className="">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-2 mt-2">
              <input
                ...
                value={option1}
                className="p-1 border border-violet-500 rounded-md"
              ></input>
              <input
                type="text"
          ...
          <div className="mt-2">
            ...
            <input
              ...
              value={correctAnswer}
              className="p-1 border border-violet-500 rounded-md w-1/4"
            />
          </div>
          <div className="mt-4 flex justify-center">
            <button
              onClick={handleQuestion}
              className={`p-2 bg-violet-500 w-20 text-white rounded-md ${
                questionNo > totalNoOfQuestions ? "hidden" : ""
              }`}
            >
              {totalNoOfQuestions === questionNo ? "Submit" : "Set"}
            </button>
          </div>
        </div>
      </div>
